...
from .indented_writer import _IndentedWriter
from .ports import (_PortGroup, _PortKind, _PORT_KINDS, _BUNDLE_KIND,
                    _port_kind, _render_scalar_find, _render_indexed_find)
...
class CppGenerator(Generator):
  ...
  def _cpp_member_type(self, port, alias_prefix: Optional[str] = None) -> str:
    ...
    if kind.member_template is not None:
      ...
      return kind.member_template.format(p=alias_prefix)
    # Every non-typed kind defines a reference member type.
    assert kind.member_ref is not None
    return kind.member_ref
  ...
  def _cpp_indexed_elem_type(self,
    ...
    """
    kind = _port_kind(port)
    if kind.indexed_elem is not None:
      return kind.indexed_elem
  ...
  def _port_find_code(self, member_name: str, port, appid) -> str:
    ...
    kind = _port_kind(port)
    v = f"{member_name}{kind.param_suffix}"
    return _render_scalar_find(kind, v, self._appid_expr(appid))

  @staticmethod
  def _port_make_unique_arg(member_name: str, port) -> str:
    """Return the argument expression for make_unique<Connected>(...)."""
    return f"{member_name}{_port_kind(port).param_suffix}"
  ...
  def _port_is_connectable(port) -> bool:
    ...
    return _port_kind(port).connectable
  ...
  def _indexed_ports_group(self, member_name: str, appid_name: str,
    ...
    find_parts.append(
        _render_indexed_find(_port_kind(first_port), map_var, appid_expr))
    find_parts.append("}")
...
class CppTypeEmitter:
  ...
  def _emit_size_assert(self, w: _IndentedWriter, type_name: str,
  ...
  def _emit_view_store(self, w: _IndentedWriter, raw_member: str, src: str,
  ...
  def _emit_field_accessor(self, w: _IndentedWriter, raw_member: str,
  ...
  def _emit_array_accessor(self, w: _IndentedWriter, raw_member: str,
                           self_type: str, field_name: str,
  ...
  def _emit_unpack(self, w: _IndentedWriter, raw_member: str, dst: str,
                   off: str, esi_type: types.ESIType, depth: int) -> None:
  ...
  def _emit_pack(self, w: _IndentedWriter, raw_member: str, src: str, off: str,
  ...
  def _emit_struct(self, w: _IndentedWriter,
  ...
  def _emit_union(self, w: _IndentedWriter,
                  union_type: types.UnionType) -> None:
  ...
  def _emit_window_frame(self, w: _IndentedWriter, frame_name: str,
                         frame_bytes: int, layout) -> None:
  ...
  def _emit_window(self, hdr: _IndentedWriter,
  ...
  def _emit_window_data_accessors(self, hdr: _IndentedWriter, info) -> None:
  ...
  def _emit_window_deserializer(self, hdr: _IndentedWriter, info) -> None:
  ...
  def _emit_alias(self, w: _IndentedWriter,
                  alias_type: types.TypeAlias) -> None:
